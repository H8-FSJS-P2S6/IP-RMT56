...
pastikan .gitignore sudah ada node_modules

npm i axios react-dom react-router react-toastify react-bootstrap bootstrap

buat folder "pages" dan "components"
mkdir src/pages src/components src/helpers src/layouts

lengkapi folder helpers
touch src/helpers/http-client.js src/helpers/useAuth.js src/pages/HomePage.jsx src/layouts/RootLayout.jsx
